...
public class GlobalExceptionHandler {
    ...
    public ProblemDetail handleMissingStaticResource(NoResourceFoundException ex) {
        ProblemDetail detail = ProblemDetail.forStatus(HttpStatus.NOT_FOUND);
        detail.setTitle("Not found");
        detail.setDetail(ex.getMessage() == null || ex.getMessage().isBlank() ? "Resource not found" : ex.getMessage());
        return detail;
    }
