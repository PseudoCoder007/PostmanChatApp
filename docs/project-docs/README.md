...
- `docs/project-docs/`: source of truth for current architecture and workflow
- [`docs/new-features/README.md`](../new-features/README.md): source of truth for future feature planning and roadmap sequencing

## Maintenance Rule

Update this folder when you:

- add a new major feature area or workspace tab
